...
public class CaeserED {
    ...
    public void decrypt() throws Exception {
        if (encrypted) {
            ...
            throw new Exception("There is no encrypted text,use encrypt() method to encrypt new one");
        }
    }
    ...
    public String getPlain() throws Exception {
        if (!this.plainText.isEmpty()) {
            ...
            throw new Exception("There is no plain text");
        }
    }
    ...
    public String getCipher() throws Exception {
        if (!this.cipherText.isEmpty()) {
            ...
            throw new Exception("There is no cipher text");
        }
    }
}
